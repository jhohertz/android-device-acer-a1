...
#define DEV_SPKR_PHONE_MONO		  ADSP_AUDIO_DEVICE_ID_SPKR_PHONE_MONO
#define DEV_SPKR_PHONE_MIC		  ADSP_AUDIO_DEVICE_ID_SPKR_PHONE_MIC

#define DEV_HEADSET_SPKR_STEREO	  ADSP_AUDIO_DEVICE_ID_HEADSET_SPKR_STEREO
#define DEV_HEADSET_MIC		  ADSP_AUDIO_DEVICE_ID_HEADSET_MIC

#define DEV_SPKR_PHONE_HEADSET_STEREO  ADSP_AUDIO_DEVICE_ID_SPKR_PHONE_MONO_W_MONO_HEADSET

#define DEV_HANDSET_SPKR		  ADSP_AUDIO_DEVICE_ID_HANDSET_SPKR
#define DEV_HANDSET_MIC		  ADSP_AUDIO_DEVICE_ID_HANDSET_MIC
